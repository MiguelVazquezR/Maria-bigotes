<div>
    ...
    <div class="grid grid-cols-3 gap-4 mt-6">
        <a href="{{ route('order-now') }}"
            ...
            <span class="uppercase mb-1 text-sm font-semibold">Ordena</span>
            <i class="fa-solid fa-motorcycle text-4xl mr-4"></i>
        </a>
        <a href="{{ route('menu') }}"
            class="flex flex-col items-center mt-5 px-1 py-2 rounded-lg shadow-md shadow-gray-500 bg-gray-300">
        ...
        <a href="{{ route('calendar.guest') }}"
            class="flex flex-col items-center mt-5 px-1 py-2 rounded-lg shadow-md shadow-gray-500 bg-gray-300">
            <p class="uppercase mb-1 text-sm font-semibold">Eventos</p>
            <i class="fa-solid fa-calendar-day text-4xl text-violet-500"></i>
        </a>
    </div>
</div>
