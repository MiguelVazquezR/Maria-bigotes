<div>
    <div class="flex justify-between items-center mt-5">
        <h1 class="font-bold">Realizar pago</h1>
    </div>
    <div class="mx-auto">
        <div class="flex items-center justify-center">
            <div class="max-w-sm w-full sm:w-1/2 lg:w-1/3 py-4 px-3 border-b">
    ...
    {{-- stripe --}}
    <div class="border-2 rounded-md px-4 py-2 my-4 dark:bg-slate-800 dark:text-gray-300">
